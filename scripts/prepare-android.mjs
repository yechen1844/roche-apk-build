...
const upsertAndroidManifestEntries = async () => {
  ...
  // 蓝牙权限
  manifest = upsertUsesPermission(manifest, 'android.permission.BLUETOOTH');
  manifest = upsertUsesPermission(manifest, 'android.permission.BLUETOOTH_ADMIN');
  manifest = upsertUsesPermission(manifest, 'android.permission.BLUETOOTH_SCAN');
  manifest = upsertUsesPermission(manifest, 'android.permission.BLUETOOTH_CONNECT');
  manifest = upsertUsesPermission(manifest, 'android.permission.ACCESS_FINE_LOCATION');
